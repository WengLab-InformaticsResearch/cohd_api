...
function pairedOEFR() {
  ...
  function displayAssociatedOEFR(data, status) {    
    ...
    var columns = ["Concept ID 2", "Concept 2 Name", "Concept 2 Domain", "Observed Count", "Expected Count", "Log Ratio"];
    var fields = ["concept_id_2", "concept_2_name", "concept_2_domain", "observed_count", "expected_count", "ln_ratio"];
    displayDynatable(data, columns, fields);
